...
public class DrawerLeftView extends RelativeLayout implements Behave {
    ...
    public DrawerLeftView(Context context) {
        super(context);
        init(context);
    }

    public DrawerLeftView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public DrawerLeftView(Context context, AttributeSet attrs, int defStyleAttr) {
